...
| -------------------- | ----------- |
| ```INICIO a, b, c <br>MONITOR a, b EXECUTE a = 5 b = 10 SOMA(a, b, c) TERMINO``` | ```#include <stdio.h> int main(void) { int a; int b; int c; a = 5; printf("%d", a); b = 10; printf("%d", b); c = a + b; return 0; }``` |
